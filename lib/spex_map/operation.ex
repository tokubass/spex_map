defmodule SpexMap.Operation do
  ...
  """
  @spec cast(OpenApiSpex.Operation.t, Conn.t, String.t | nil, %{String.t => Schema.t}) :: {:ok, map} | {:error, String.t}
  ...
  """
  @spec validate(OpenApiSpex.Operation.t, Conn.t, String.t | nil, %{String.t => Schema.t}) :: :ok | {:error, String.t}
